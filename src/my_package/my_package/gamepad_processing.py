    ...
    def __data_processing(self, name, value):
        if name == "RK1_LEFT_RIGHT":
            ...
            if value == 0:
                ...
                fvalue = int(self.__my_map(self.__step_control, 20,
                             100, 30, self.__STEP_SCALE_Z*100))*value
            ...
            if value == 1:
                ...
                if self.__play_ball == 0:
                    self.__play_ball = 2
                    task_1 = threading.Thread(target=self.__play_ball_task, args=(
                        self.__play_ball,), name="play_ball_task")
